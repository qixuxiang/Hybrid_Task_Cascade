...
datasets_path = 'jinnan2_round2_train_20190401/'

f = open('{}train_restriction.json'.format(datasets_path) ,encoding='utf-8')
gt = json.load(f)
...
with open("./annotations/train.json", 'w', encoding='utf-8') as json_file:
    json.dump(train, json_file, ensure_ascii=False)

with open("./annotations/val.json", 'w', encoding='utf-8') as json_file:
